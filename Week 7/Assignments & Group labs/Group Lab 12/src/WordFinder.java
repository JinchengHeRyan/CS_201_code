...
public interface WordFinder {
	/**
	 * Represents a potential play and the letters to be used from the player's hand.
	 */
	 ...
	 * @param wordListFilename path or URL to list of words (same format used by Board)
	 * @param maxWordLength cutoff length for words -- words longer than the cutoff will not be indexed
	 */
